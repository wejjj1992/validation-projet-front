...
export default class ProductsUpdateAdmin extends Component {
    ...
    componentDidMount() {
        ...
        API.get(`product/` + id)
            .then(res => {
                ...
                this.setState({ product: product, id: product._id, title: product.title, description: product.description, imageUrl: product.imageUrl, price: product.price });
